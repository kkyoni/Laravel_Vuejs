...
<div class="row wrapper border-bottom white-bg page-heading">
	<div class="col-lg-12">
		<h2><i class="fa fa-question-circle" aria-hidden="true"></i> Users Management</h2>
		<ol class="breadcrumb">
			...
			<div class="ibox">
				<div class="ibox-content">
					<div class="col-md-12 text-right">
						<a class="btn btn-primary btn-sm pull-right mb-3 op-btn them" href="{{route('admin.user.create')}}"><i class="fa fa-plus"></i> Add Users</a>
	...
	swal({
		...
		if (isConfirm) {
			$.ajax({
				...
				success:function(msg){
					if(msg.status == 'success'){
						swal({title: "Status",text: "Status Success Update",type: "success"},
							function(){
								location.reload();
							});
					}else{
